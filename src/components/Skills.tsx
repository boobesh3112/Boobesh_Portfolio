...
import { Terminal, Code, Cpu, Cloud, CheckCircle } from 'lucide-react';
    ...
    <section id="skills" className="py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        ...
        <div className="mb-16 text-center sm:text-left">
          ...
          {/* Dynamic Scroll Velocity Marquee */}
          <div className="mt-8 mb-6 py-2 border-y opacity-90 overflow-hidden" style={{ borderColor: theme.borderColor }}>
            <ScrollVelocity
              texts={[
                'REACT • TYPESCRIPT • NODE.JS • GEMINI AI • PYTHON • TAILWIND CSS • ARDUINO IoT • SUPABASE • ',
                'AI & DATA SCIENCE • FULL-STACK ARCHITECTURE • HARDWARE TINKERING • VIBE CODING • JETPACK COMPOSE • '
              ]}
              velocity={60}
              className="font-mono text-sm sm:text-base uppercase font-extrabold tracking-wider px-4"
              parallaxStyle={{ color: theme.accentPrimary }}
            />
          </div>
        </div>
