...
const CONNECTIONS: SocialPlatform[] = [
  ...
  },
  {
    ...
    handle: '@boobesh.j',
    href: 'https://www.instagram.com/_boobesh._?igsh=aGFucWRzMm9ocnQ4',
    brandColor: '#E4405F',
    icon: Instagram,
  },
  {
    ...
    handle: 'boobesh.j',
    href: 'https://www.facebook.com/share/1BRdJUjoKq/',
    brandColor: '#1877F2',
    icon: Facebook,
  },
  {
  ...
  },
  {
    ...
    handle: '@boobesh_j',
    href: 'https://t.me/gangster_gaming_yt',
    brandColor: '#229ED9',
    icon: Send,
  },
  {
    ...
    handle: '@boobesh.j',
    href: 'https://www.threads.com/@_boobesh._',
    brandColor: '#a855f7',
    icon: AtSign,
  },
  {
    ...
    handle: 'boobesh#0001',
    href: 'https://discord.com/users/boobesh1231',
    brandColor: '#5865F2',
    icon: MessageSquare,
  },
];
